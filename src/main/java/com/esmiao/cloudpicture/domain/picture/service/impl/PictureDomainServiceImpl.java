package com.esmiao.cloudpicture.domain.picture.service.impl;
...
import com.esmiao.cloudpicture.domain.picture.service.PictureDomainService;
import com.esmiao.cloudpicture.domain.picture.valueObject.PictureReviewStatusEnum;
import com.esmiao.cloudpicture.domain.user.entity.User;
import com.esmiao.cloudpicture.infrastructure.api.ai.aliyun.AliYunAiApi;
...
import com.esmiao.cloudpicture.infrastructure.api.oss.ObjectStorage;
import com.esmiao.cloudpicture.infrastructure.utils.ColorSimilarUtil;
import com.esmiao.cloudpicture.interfaces.assembler.PictureEntityFactory;
...
import com.esmiao.cloudpicture.infrastructure.manager.storage.FilePictureStorageManager;
import com.esmiao.cloudpicture.infrastructure.manager.storage.UrlPictureStorageManager;
...
public class PictureDomainServiceImpl implements PictureDomainService {
    ...
    public QueryWrapper<Picture> generateQueryWrapper(PictureQueryRequest pictureQueryRequest) {
        ...
        Long id = StrUtil.isNotBlank(pictureQueryRequest.getId()) ? Long.parseLong(pictureQueryRequest.getId()) : null;
        ...
        queryWrapper.eq(pictureQueryRequest.isPublicSpace(), "spaceId", SpaceConstant.PUBLIC_SPACE_ID);
